    ...
    function ImagesGrid(cfg) {
        ...
        this.align = function() {
            ...
            switch (len) {
				...
				case 7:
				case 8:
					this.alignItems(this.$gridItems.slice(0, 4));
                    this.alignItems(this.$gridItems.slice(4));
                    break;
				case 9:
				case 10:
					this.alignItems(this.$gridItems.slice(0, 5));
                    this.alignItems(this.$gridItems.slice(5));
                    break;				
            }
